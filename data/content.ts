...
export const profile = {
  ...
  title: "AI Architect",
  summary:
    "I architect, build, and own production AI systems: RAG platforms, evaluation infrastructure, model-routing pipelines, and the deployment plumbing that keeps them reliable, measurable, and cost-aware.",
...
const dataEngineerHighlights = [
  ...
  },
  {
    ...
    body: "Implemented CloudWatch and OpenTelemetry instrumentation with drift detection and alerting. Reduced mean time to diagnose failures from hours to minutes.",
  },
];

const ekincareHighlights = [
  {
  ...
  },
  {
    ...
    body: "Tracked down recurring failure patterns and rebuilt the logging, monitoring, and alerting.",
  },
];
...
export const experience = [
  {
    ...
    highlights: aiArchitectHighlights,
    items: aiArchitectHighlights,
    stack: ["AWS EKS", "Azure", "GPT-4o PTU", "GPT-4o Vision", "YOLOv8", "OpenCV", "Azure Functions", "Cosmos DB", "Llama 3", "LoRA/PEFT", "DPO", "RAGAS", "OpenTelemetry", "LangGraph", "Bicep"],
  },
  {
    company: "CGI",
    role: "Data Engineer",
    ...
    highlights: dataEngineerHighlights,
    items: dataEngineerHighlights,
  ...
  },
  {
    ...
    highlights: ekincareHighlights,
    items: ekincareHighlights,
...
export const projects = [
  {
    ...
    description: "Control your Mac from your phone via Telegram. Send a natural language command, a six-agent pipeline builds and executes a plan, with mandatory tap-to-approve before anything runs.",
    bullets: [
      ...
      "**Safety model:** approval enforced in code, dangerous commands blocked, every file backed up before writes, and workspace access sandboxed.",
  ...
  },
  {
    ...
    description: "Takes a JIRA ticket ID and autonomously reads the ticket, generates a GPT-4 code fix, validates with tests, and opens a GitHub PR.",
    bullets: [
      ...
      "**QA agent** runs tests against the fix. Failed results loop back to Developer for up to three cycles.",
  ...
  },
  {
    ...
    description: "A production-ready framework for A/B evaluating LLM changes with statistical rigor and CI integration, making evaluation a real deployment gate.",
    bullets: [
      "**Hard checks first:** schema, citations, and format are deterministic and low cost. Only passing cases proceed to LLM judge.",
      "**LLM-as-judge with calibration:** rubric pairwise scoring with agreement, flip rate, and order bias measurement.",
      "**95% bootstrap CI** on win rate, plus per-tag breakdowns and refusal / format pass rates.",
      "**Quality gates:** configurable thresholds and exit code 2 on failure to block CI.",
    ],
